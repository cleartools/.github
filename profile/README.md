...
| --- | --- |
| [`scclrR`](https://github.com/cleartools/scclrR) | R/Seurat package for sparse PFlog normalization and PCA, including a rendered Angelidis pseudobulk vignette. |
| [`scclr`](https://github.com/cleartools/scclr) | Python package for sparse PFlog normalization and sparse PCA on AnnData and MuData objects. |
| [`runorm`](https://github.com/cleartools/runorm) | Rust normalization routines for shifted centered log-ratio / PFlog transformations. |
